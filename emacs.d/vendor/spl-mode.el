...
(defconst spl-font-lock-keywords-1
  (list '("\\<\\(namespace\\|composite\\|param\\|type\\|var\\|graph\\|config\\|logic\\|window\\|state\\input\\|state\\|onTuple\\|onPunct\\|output\\)\\>" 
        ...
        '("\\<\\(Custom\\|Beacon\\|Functor\\|Filter\\|DynamicFilter\\|Punctor\\|Aggregate\\|DeDuplicate\\|ThreadedSplit\\|Barrier\\|Pair\\|Sort\\|Split\\|Delay\\|Throttle\\|Join\\|Union\\|DirectoryScan\\|FileSource\\|FileSink\\|TCPSource\\|TCPSink\\|UDPSource\\|UDPSink\\|PerfSink\\|Import\\|Export\\)\\>" 
...
(defconst spl-font-lock-keywords-2
  (append spl-font-lock-keywords-1
    (list '("\\<\\(threadedPort\\|queue\\|checkpoint\\|defaultPool\\|haReplicas\\|placement\\|partition\\|host\\|\\(\\(partition\\|host\\)\\(Exlocation\\|Colocation\\|Isolation\\)\\)\\|hostPool\\|logLevel\\|relocatable\\|restartable\\|wrapper\\consistency\\|atomic\\|causal\\|loose\\|lifetime\\|ethernal\\|transient\\|readsPerSecond\\|sizeHint\\|writesPerSecond\\)\\>" 
...
(defconst spl-font-lock-keywords-3
  (append spl-font-lock-keywords-2
    (list '("\\<\\(void\\|boolean\\|enum\\|\\(\\(int\\|uint\\|float\\|decimal\\|complex\\)\\(8\\|16\\|32\\|64\\|128\\)\\)\\|timestamp\\|blob\\|rstring\\|ustring\\|list\\|map\\|set\\|tuple\\)\\>" 
           . spl-font-lock-type-name-face)
          '("\\<\\(\\true\\|false\\|\\(\\([0-9]+\\|\\([0-9]*\\.[0-9]+\\([+-]e[0-9]+\\)?\\)\\)\\(s\\|u\\|f\\|d\\)?\\(b\\|h\\|w\\|l\\|q\\)?\\)\\)\\>" 
           . spl-font-lock-literal-face)))
   "Balls-out highlighting in SPL mode")
